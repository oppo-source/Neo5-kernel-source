...
//#ifndef VENDOR_EDIT
//wenjie.Liu@Prd.SysApp.PowerManager, 2014/03/22, Remove for 
/*
...
void get_pcb_version_readfile(void)
{
	...
	sprintf(path, "/proc/oppoVersion/pcbVersion");
	fp = fopen(path, "r");
	if(fp == NULL) {
		//return false;
	...
	fclose(fp); 
	if (strstr(cmdline, "com.android.cts.")
	{
